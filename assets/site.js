...
(function () {
  ...
  var I18N = {
    ru: {
      ...
      'p.baik.lead':"Присоединяйтесь к нашим групповым турам с наблюдением пуска космических кораблей. Между пусками мы предлагаем индивидуальные туры с экскурсиями по космодрому и городу Байконур.",
      'p.baik.eyebrow':"Туроператор по Байконуру с 2015 года",
      'p.baik.h2':"Из казахской степи к звёздам",
      'p.baik.ab1':"Космодром Байконур занимает около 6 717 квадратных километров и включает более 200 площадок, связанных со сборкой, испытаниями, заправкой и запуском космической техники. Его территория простирается примерно на 200 километров с севера на юг и на 300 километров с запада на восток.",
      'p.baik.ab2':"Ворота космодрома — контрольно-пропускной пункт №7 — расположены примерно в 30 минутах езды от города Байконур. И это только начало пути по огромной территории.",
      'p.baik.ab3':"Тур на Байконур — уникальная возможность прикоснуться к истории освоения космоса и стать свидетелем реальных космических запусков. Следите за обновлениями расписания пусков.",
      'p.baik.p1':"Байконур — закрытый город и действующий космодром. Для посещения необходим специальный пропуск. Документы для участия в турах на пуски необходимо подать заранее: иностранцам — за 60 дней, гражданам стран СНГ — за 20 дней. Мы организуем групповые туры по системе «всё включено».",
      'p.baik.li1':"Пропуска в город Байконур и на территорию космодрома",
      'p.baik.li2':"Встреча и проводы в аэропорту Кызылорды",
      'p.baik.li3':"Проживание и питание",
      'p.baik.li4':"Экскурсии, транспорт и сопровождение гида",
      ...
      'p.baik.booknote':"Откройте нужный тур и оставьте заявку на бронирование.",
      ...
      'p.ind.lead':"Оставьте заявку — организуем индивидуальный тур под ваши даты, маршрут, состав группы и бюджет.",
      'p.ind.eyebrow':"Как это работает",
      'p.ind.h2':"Путешествие, которого нет в каталоге",
      'p.ind.p1':"Вы рассказываете о мечте — мы превращаем её в маршрут. Подбираем локации, отели, гидов и логистику так, чтобы поездка была именно вашей.",
      'p.ind.l1':"Персональный менеджер и гид",
      'p.ind.l2':"Гибкие даты и темп",
      'p.ind.l3':"Отели и трансферы любого уровня",
      'p.ind.l4':"Уникальные локации и впечатления",
      'p.ind.ex_h':"Примеры маршрутов",
      'p.ind.ex_s':"Идеи, которые можно адаптировать под вас",
      'p.ind.tag':"Под заказ",
      'p.ind.t1':"Фототур по Тянь-Шаню",
      'p.ind.s1':"Озёра, рассветы и горные перевалы",
      'p.ind.t2':"Экспедиция по Мангистау",
      'p.ind.s2':"Внедорожники и ночёвки под звёздами",
      'p.ind.t3':"Шёлковый путь VIP",
      'p.ind.s3':"Туркестан, Самарканд, Бухара",
      'p.ind.term':"срок",
      'p.ind.d1':"5–10 дней",
      'p.ind.d2':"4–7 дней",
      'p.ind.d3':"7–12 дней",
      'p.ind.disc':"Обсудить",
      'p.ind.doc_eye':"Перед отправкой",
      'p.ind.doc_h':"Документы и условия",
      'p.ind.doc_p':"Ознакомьтесь с условиями оказания услуг и обработки персональных данных — отметку о согласии нужно поставить в форме.",
      'p.ind.doc1':"Публичная оферта",
      'p.ind.doc1s':"Договор на оказание услуг: бронирование, оплата, ответственность",
      'p.ind.doc2':"Политика конфиденциальности",
      'p.ind.doc2s':"Какие данные мы собираем и как их используем",
      'p.ind.doc3':"Условия возврата",
      'p.ind.doc3s':"Невозвратные тарифы и когда возврат возможен",
      'p.ind.doc4':"Оплата банковской картой",
      'p.ind.doc4s':"Как проходит платёж и что такое 3-D Secure",
      'p.ind.form_h':"Заявка на индивидуальный тур",
      'p.ind.form_p':"Опишите идею — менеджер свяжется с вами и предложит маршрут и смету.",
      'p.ind.f_wish':"Пожелания",
      'p.ind.f_wish_ph':"Направление, примерные даты, число человек, бюджет и особые пожелания",
      'p.ind.agree':"Я согласен с",
      'p.ind.agree1':"условиями публичной оферты",
      'p.ind.agree_and':"и",
      'p.ind.agree2':"политикой конфиденциальности",
      'gr_all':"Все туры",
    ...
    kz: {
      ...
      'p.baik.lead':"Біздің ғарыш кемелерінің ұшырылымын тамашалауға арналған топтық турларымызға қосылыңыз. Ұшырылымдар арасында Байқоңыр ғарыш айлағы мен Байқоңыр қаласына экскурсиялармен жеке турлар ұсынамыз.",
      'p.baik.eyebrow':"2015 жылдан бері Байқоңыр бойынша туроператор",
      'p.baik.h2':"Қазақ даласынан жұлдыздарға",
      'p.baik.ab1':"Байқоңыр ғарыш айлағы шамамен 6 717 шаршы километр аумақты алып жатыр және ғарыш техникасын құрастыруға, сынақтан өткізуге, жанармай құюға және ұшыруға арналған 200-ден астам алаңды қамтиды. Оның аумағы солтүстіктен оңтүстікке қарай шамамен 200 километрге, батыстан шығысқа қарай 300 километрге созылып жатыр.",
      'p.baik.ab2':"Ғарыш айлағының қақпасы — №7 бақылау-өткізу пункті — Байқоңыр қаласынан шамамен 30 минуттық жерде орналасқан. Ал бұл — ғарыш айлағының орасан зор аумағына басталатын жолдың тек басы.",
      'p.baik.ab3':"Байқоңырға саяхат — ғарышты игеру тарихына жақындап, нақты ғарыш ұшырылымдарының куәсі болудың бірегей мүмкіндігі. Ұшырулар кестесіндегі жаңартуларды қадағалаңыз.",
      'p.baik.p1':"Байқоңыр — жабық қала және жұмыс істеп тұрған ғарыш айлағы. Бару үшін арнайы рұқсат қажет. Ұшыруларға арналған турларға қатысу үшін құжаттарды алдын ала тапсыру қажет: шетел азаматтары үшін — кемінде 60 күн бұрын, ТМД елдерінің азаматтары үшін — 20 күн бұрын. Біз «барлығы қамтылған» форматында топтық турлар ұйымдастырамыз.",
      'p.baik.li1':"Байқоңыр қаласына және ғарыш айлағына кіруге арналған рұқсаттар",
      'p.baik.li2':"Қызылорда әуежайында қарсы алу және шығарып салу",
      'p.baik.li3':"Тұру және тамақтану",
      'p.baik.li4':"Экскурсиялар, көлік және гид қызметтері",
      ...
      'p.baik.booknote':"Қажетті турды ашып, брондауға өтінім қалдырыңыз.",
      ...
      'p.ind.lead':"Өтінім қалдырыңыз — күндеріңізге, бағытыңызға, топ құрамына және бюджетіңізге сай жеке тур ұйымдастырамыз.",
      'p.ind.eyebrow':"Бұл қалай жұмыс істейді",
      'p.ind.h2':"Каталогта жоқ саяхат",
      'p.ind.p1':"Сіз армандаған саяхатыңызды айтасыз — біз оны нақты маршрутқа айналдырамыз. Орындарды, қонақүйлерді, гидтер мен логистиканы дәл сізге қарай таңдаймыз.",
      'p.ind.l1':"Жеке менеджер және гид",
      'p.ind.l2':"Икемді күндер мен қарқын",
      'p.ind.l3':"Кез келген деңгейдегі қонақүйлер мен трансферлер",
      'p.ind.l4':"Бірегей орындар мен әсерлер",
      'p.ind.ex_h':"Маршрут үлгілері",
      'p.ind.ex_s':"Сізге бейімдеуге болатын идеялар",
      'p.ind.tag':"Тапсырыс бойынша",
      'p.ind.t1':"Тянь-Шань бойынша фототур",
      'p.ind.s1':"Көлдер, таң сәрі және тау асулары",
      'p.ind.t2':"Маңғыстау экспедициясы",
      'p.ind.s2':"Жол талғамайтын көліктер және жұлдыз астындағы түнеу",
      'p.ind.t3':"Жібек жолы VIP",
      'p.ind.s3':"Түркістан, Самарқанд, Бұхара",
      'p.ind.term':"мерзімі",
      'p.ind.d1':"5–10 күн",
      'p.ind.d2':"4–7 күн",
      'p.ind.d3':"7–12 күн",
      'p.ind.disc':"Талқылау",
      'p.ind.doc_eye':"Жіберу алдында",
      'p.ind.doc_h':"Құжаттар мен шарттар",
      'p.ind.doc_p':"Қызмет көрсету шарттарымен және дербес деректерді өңдеу саясатымен танысыңыз — келісім белгісін формада қою қажет.",
      'p.ind.doc1':"Жария оферта",
      'p.ind.doc1s':"Қызмет көрсету шарты: брондау, төлем, жауапкершілік",
      'p.ind.doc2':"Құпиялылық саясаты",
      'p.ind.doc2s':"Қандай деректерді жинаймыз және оларды қалай пайдаланамыз",
      'p.ind.doc3':"Қайтару шарттары",
      'p.ind.doc3s':"Қайтарылмайтын тарифтер және қайтару мүмкін болатын жағдайлар",
      'p.ind.doc4':"Банк картасымен төлеу",
      'p.ind.doc4s':"Төлем қалай жүреді және 3-D Secure дегеніміз не",
      'p.ind.form_h':"Жеке турға өтінім",
      'p.ind.form_p':"Идеяңызды сипаттаңыз — менеджер сізбен байланысып, маршрут пен смета ұсынады.",
      'p.ind.f_wish':"Тілектеріңіз",
      'p.ind.f_wish_ph':"Бағыт, шамамен күндер, адам саны, бюджет және ерекше тілектер",
      'p.ind.agree':"Мен келісемін:",
      'p.ind.agree1':"жария оферта шарттарымен",
      'p.ind.agree_and':"және",
      'p.ind.agree2':"құпиялылық саясатымен",
    ...
    en: {
      ...
      'p.baik.h1':"Tours to the Baikonur Cosmodrome",
      'p.baik.lead':"Join our group tours with an opportunity to observe a spacecraft launch. Between launches, we offer private tours with excursions around the Baikonur Cosmodrome and the city of Baikonur.",
      'p.baik.eyebrow':"Baikonur Tour Operator Since 2015",
      'p.baik.h2':"From the Kazakh steppe to the stars",
      'p.baik.ab1':"The Baikonur Cosmodrome covers approximately 6,717 square kilometres and includes more than 200 sites dedicated to the assembly, testing, fueling, and launch of spacecraft. Its territory stretches approximately 200 kilometres from north to south and 300 kilometres from west to east.",
      'p.baik.ab2':"The gateway to the cosmodrome — Checkpoint No. 7 — is located about a 30-minute drive from Baikonur city. And this is only the beginning of the journey across the vast territory.",
      'p.baik.ab3':"A tour of Baikonur is a unique opportunity to experience the history of space exploration and witness real space launches. Follow the latest launch schedule updates.",
      'p.baik.p1':"Baikonur is a closed city and an active spaceport. A special permit is required to visit. Documents for launch tours must be submitted in advance: at least 60 days for foreign citizens and 20 days for citizens of CIS countries. We organize all-inclusive group tours.",
      'p.baik.li1':"Permits to enter Baikonur city and the Cosmodrome",
      'p.baik.li2':"Meet and greet at Kyzylorda Airport",
      'p.baik.li3':"Accommodation and meals",
      'p.baik.li4':"Excursions, transportation and guide services",
      ...
      'p.baik.booknote':"Open a tour and send a booking request.",
      ...
      'p.ind.lead':"Send a request and we'll arrange a tailor-made tour for your dates, route, group size and budget.",
      'p.ind.eyebrow':"How it works",
      'p.ind.h2':"A journey you will not find in any catalogue",
      'p.ind.p1':"You tell us about your dream trip and we turn it into an itinerary — choosing the places, hotels, guides and logistics that fit you.",
      'p.ind.l1':"A personal manager and guide",
      'p.ind.l2':"Flexible dates and pace",
      'p.ind.l3':"Hotels and transfers at any level",
      'p.ind.l4':"Unique places and experiences",
      'p.ind.ex_h':"Sample itineraries",
      'p.ind.ex_s':"Ideas we can adapt to you",
      'p.ind.tag':"On request",
      'p.ind.t1':"Tien Shan photo tour",
      'p.ind.s1':"Lakes, sunrises and mountain passes",
      'p.ind.t2':"Mangystau expedition",
      'p.ind.s2':"Off-road vehicles and nights under the stars",
      'p.ind.t3':"Silk Road VIP",
      'p.ind.s3':"Turkistan, Samarkand, Bukhara",
      'p.ind.term':"duration",
      'p.ind.d1':"5–10 days",
      'p.ind.d2':"4–7 days",
      'p.ind.d3':"7–12 days",
      'p.ind.disc':"Discuss",
      'p.ind.doc_eye':"Before you send",
      'p.ind.doc_h':"Documents and terms",
      'p.ind.doc_p':"Please review our terms of service and privacy policy — you will need to tick the consent box in the form.",
      'p.ind.doc1':"Public offer",
      'p.ind.doc1s':"Service agreement: booking, payment, liability",
      'p.ind.doc2':"Privacy policy",
      'p.ind.doc2s':"What data we collect and how we use it",
      'p.ind.doc3':"Refund terms",
      'p.ind.doc3s':"Non-refundable fares and when a refund is possible",
      'p.ind.doc4':"Card payment",
      'p.ind.doc4s':"How the payment works and what 3-D Secure is",
      'p.ind.form_h':"Tailor-made tour request",
      'p.ind.form_p':"Describe your idea — our manager will get in touch with a route and a quote.",
      'p.ind.f_wish':"Your wishes",
      'p.ind.f_wish_ph':"Destination, approximate dates, number of travellers, budget and any special requests",
      'p.ind.agree':"I agree to the",
      'p.ind.agree1':"terms of the public offer",
      'p.ind.agree_and':"and the",
      'p.ind.agree2':"privacy policy",
      'gr_all':"All tours",
