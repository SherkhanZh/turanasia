...
(function () {
  ...
  var I18N = {
    ru: {
      ...
      'foot.about':'Современный туроператор по Казахстану и Центральной Азии. Авторские маршруты, местные гиды, забота на каждом этапе.','foot.tours':'Туры','foot.company':'Компания','foot.contacts':'Контакты','foot.menu':'Меню','foot.social':'Мы в соцсетях','foot.kz':'По Казахстану','foot.foreign':'Зарубежные','foot.individual':'Индивидуальные','foot.reviews':'Отзывы','foot.hotels':'Отели','foot.cruises':'Круизы','foot.dests':'Направления','foot.hours':'Пн–Пт: 9:00–18:00','foot.addr':'Алматы, пр. Абая 117/6','foot.rights':'© 2025 Turan Asia. Все права защищены.','foot.privacy':'Политика конфиденциальности','foot.terms':'Условия'
    },
    kz: {
      ...
      'foot.about':'Қазақстан және Орталық Азия бойынша заманауи туроператор. Авторлық бағыттар, жергілікті гидтер, әр кезеңде қамқорлық.','foot.tours':'Турлар','foot.company':'Компания','foot.contacts':'Байланыс','foot.menu':'Мәзір','foot.social':'Әлеуметтік желілерде','foot.kz':'Қазақстан бойынша','foot.foreign':'Шетелдік','foot.individual':'Жеке','foot.reviews':'Пікірлер','foot.hotels':'Қонақүйлер','foot.cruises':'Круиздер','foot.dests':'Бағыттар','foot.hours':'Дс–Жм: 9:00–18:00','foot.addr':'Алматы, Абай даңғ. 117/6','foot.rights':'© 2025 Turan Asia. Барлық құқықтар қорғалған.','foot.privacy':'Құпиялылық саясаты','foot.terms':'Шарттар'
    },
    en: {
      ...
      'foot.about':'A modern tour operator across Kazakhstan and Central Asia. Original routes, local guides, care at every step.','foot.tours':'Tours','foot.company':'Company','foot.contacts':'Contacts','foot.menu':'Menu','foot.social':'Follow us','foot.kz':'In Kazakhstan','foot.foreign':'International','foot.individual':'Tailor-made','foot.reviews':'Reviews','foot.hotels':'Hotels','foot.cruises':'Cruises','foot.dests':'Destinations','foot.hours':'Mon–Fri: 9:00–18:00','foot.addr':'Almaty, 117/6 Abay Ave.','foot.rights':'© 2025 Turan Asia. All rights reserved.','foot.privacy':'Privacy Policy','foot.terms':'Terms'
    }
  };
