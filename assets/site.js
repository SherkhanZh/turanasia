...
(function () {
  ...
  var I18N = {
    ru: {
      ...
      'p.baik.h2':"Из казахской степи к звёздам, от первого полёта к новым космическим миссиям.",
      'p.baik.p1':"Байконур — закрытый город и действующий космодром. Попасть в город и на космодром возможно только по специальному разрешению. Для участия в турах на пуски документы иностранных граждан необходимо подать не менее чем за 60 календарных дней, граждан стран СНГ — не менее чем за 20 календарных дней. Планируйте посещение заранее. Мы организуем групповые туры по системе «всё включено».",
      'p.baik.li1':"<b>Пропуска</b> в город Байконур и на территорию космодрома",
      'p.baik.li2':"<b>Встреча и проводы</b> в аэропорту Кызылорды или на железнодорожной станции Торетам",
      'p.baik.li3':"<b>Проживание и питание</b> на протяжении тура",
      'p.baik.li4':"<b>Экскурсии, транспортное обслуживание и сопровождение гида</b>",
    ...
    kz: {
      ...
      'p.baik.h2':"Қазақ даласынан жұлдыздарға, алғашқы ұшудан жаңа ғарыштық миссияларға дейін.",
      'p.baik.p1':"Байқоңыр — жабық қала және жұмыс істеп тұрған ғарыш айлағы. Қалаға және ғарыш айлағына кіру арнайы рұқсат арқылы ғана жүзеге асырылады. Ұшыруларға арналған турларға қатысу үшін шетел азаматтарының құжаттары кемінде 60 күнтізбелік күн бұрын, ал ТМД елдерінің азаматтарының құжаттары кемінде 20 күнтізбелік күн бұрын тапсырылуы тиіс. Сапарыңызды алдын ала жоспарлаңыз. Біз «барлығы қамтылған» форматында топтық турлар ұйымдастырамыз.",
      'p.baik.li1':"<b>Байқоңыр қаласына және ғарыш айлағына кіруге арналған рұқсаттар</b>",
      'p.baik.li2':"<b>Әуежайдан немесе теміржол вокзалынан трансфер</b> — Қызылорда әуежайында немесе Төретам теміржол станциясында қарсы алу және шығарып салу",
      'p.baik.li3':"<b>Тур бойы тұру және тамақтану</b>",
      'p.baik.li4':"<b>Экскурсиялар, көлік қызметі және гидтің сүйемелдеуі</b>",
    ...
    en: {
      ...
      'p.baik.h2':"From the Kazakh steppe to the stars, from the first flight to new space missions.",
      'p.baik.p1':"Baikonur is a closed city and an active spaceport. Access to the city and the Cosmodrome is only possible with a special permit. For launch tours, documents for foreign citizens must be submitted at least 60 calendar days in advance, and for citizens of CIS countries, at least 20 calendar days in advance. Please plan your visit in advance. We organize all-inclusive group tours.",
      'p.baik.li1':"<b>Permits</b> for entry to Baikonur city and the Cosmodrome",
      'p.baik.li2':"<b>Airport or railway station transfers</b> — meet and greet at Kyzylorda Airport or Toretem Railway Station",
      'p.baik.li3':"<b>Accommodation and meals</b> throughout the tour",
      'p.baik.li4':"<b>Excursions, transportation and guide services</b>",
